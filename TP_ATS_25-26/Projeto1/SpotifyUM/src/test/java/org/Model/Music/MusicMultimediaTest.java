...
public class MusicMultimediaTest {
    ...
    @Test
    public void testEqualsNullUrl() {
        MusicMultimedia m1 = new MusicMultimedia(NAME, INTERPRETER, PUBLISHER, LYRICS,
                MUSICAL_FIGURES, GENRE, ALBUM, DURATION, EXPLICIT, null);
        MusicMultimedia m2 = new MusicMultimedia(NAME, INTERPRETER, PUBLISHER, LYRICS,
                MUSICAL_FIGURES, GENRE, ALBUM, DURATION, EXPLICIT, null);
        MusicMultimedia m3 = new MusicMultimedia(NAME, INTERPRETER, PUBLISHER, LYRICS,
                MUSICAL_FIGURES, GENRE, ALBUM, DURATION, EXPLICIT, "http://url");
        assertEquals(m1, m2);
        assertNotEquals(m1, m3);
    }

    @Test
    public void testEqualsNotMusicMultimedia() {
        assertNotEquals(musicMultimedia, new Music(NAME, INTERPRETER, PUBLISHER, LYRICS,
